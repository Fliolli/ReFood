                        ...
                        children: <Widget>[
                          Padding(
                            ...
                            child: ClipRRect(
                              borderRadius: BorderRadius.circular(60),
                              child: Image.network(
                                  orderCardItemTrimmed._ownerProfileImage.toString(),
                                  height: 25,
                                  width: 25,
                                  fit: BoxFit.cover),
                            ),
...
class OrderCardItemTrimmed {
  ...
  OrderCardItemTrimmed(this._id, this._image, this._name, this._price, this._unit,
      this._ownerName, this._ownerRating, this._ownerProfileImage);
}
